...
public class StringUtils extends org.springframework.util.StringUtils {
    ...
    public static String getFileType(String name) {
        ...
        if (name.equalsIgnoreCase("png") || name.equalsIgnoreCase("jpg")
            || name.equalsIgnoreCase("jpeg") || name.equalsIgnoreCase("gif")) {
            return "pic";
        }
        return name;
    }
     ...
     * @return
     */
    public static String moneyToString(BigDecimal amount) {
     ...
     * @return
     */
    public static String randomNum(int number) {
        int num = new Random().nextInt(number);
        String str = String.valueOf(num);
        if (String.valueOf(num).length() < String.valueOf(number).length()) {
            int length = String.valueOf(number).length() - String.valueOf(num).length();
    ...
    public static boolean isEmpty(Object obj) {
        if (obj == null || obj.toString().equals(BaseBizConstants.EMTPY_STR)) {
            return true;
        }
        return false;
    }
