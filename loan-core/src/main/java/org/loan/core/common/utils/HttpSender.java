...
public class HttpSender {
    ...
    public static Map<String, Object> getResponseString(String method, String url, String sendData,
    ...
    public static Map<String, Object> getResponseBytes(String method, String url, String sendData,
                                                       Map<String, String> headers) throws IOException {
    ...
    private static class HttpRequester {
        public static Map<String, Object> request(String method, String url, Object sendData,
                                                  Map<String, String> headers) throws IOException {
            ...
            if (sendData != null) {
                ...
                if (sendData instanceof String) {
                    ...
                    throw new RuntimeException(
                        "sendData not support for this Class, only byte[] or string");
                }
